...
class Deplacements(object):
    ...
    def kneel2(self):
        ...
        times.append([ 0.06667, 2.73333])
        keys.append([ [ 1.39626, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ 1.41721, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LShoulderRoll")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ 0.34907, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ 0.66323, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LElbowYaw")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ -1.39626, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ -0.25831, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LElbowRoll")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ -1.04720, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ -1.08210, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LWristYaw")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ 0.00000, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ 1.14668, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LHand")
        times.append([ 0.06667])
        keys.append([ [ 0.00000, [ 2, -0.02222, 0.00000], [ 2, 0.00000, 0.00000]]])
        ...
        times.append([ 2.73333])
        keys.append([ [ -0.05365, [ 2, -0.91111, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LHipRoll")
        times.append([ 2.73333])
        keys.append([ [ -0.02269, [ 2, -0.91111, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LHipPitch")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ -0.43633, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ -0.87441, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LKneePitch")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ 0.69813, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ 2.11185, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LAnklePitch")
        times.append([ 0.06667, 2.73333])
        keys.append([ [ -0.34907, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ -1.18952, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("LAnkleRoll")
        times.append([ 2.73333])
        keys.append([ [ 0.00771, [ 2, -0.91111, 0.00000], [ 2, 0.00000, 0.00000]]])
        ...
        times.append([ 0.06667, 2.73333])
        keys.append([ [ -0.34907, [ 2, -0.02222, 0.00000], [ 2, 0.88889, 0.00000]], [ -1.18645, [ 2, -0.88889, 0.00000], [ 2, 0.00000, 0.00000]]])
        
        names.append("RAnkleRoll")
        times.append([ 2.73333])
        keys.append([ [ -0.01530, [ 2, -0.91111, 0.00000], [ 2, 0.00000, 0.00000]]])
